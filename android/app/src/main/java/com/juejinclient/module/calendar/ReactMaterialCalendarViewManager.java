...
import static com.juejinclient.module.calendar.Utils.getDayOfWeekFromString;
...
public class ReactMaterialCalendarViewManager extends SimpleViewManager<ReactMaterialCalendarView> {
    ...
    public void setOtherColor(ReactMaterialCalendarView view) {
        view.setDateTextAppearance(R.style.CustomTextAppearance);
        view.setHeaderTextAppearance(R.style.CustomTextAppearance);
        view.setWeekDayTextAppearance(R.style.CustomTextAppearance);
        view.setArrowColor(Color.WHITE);
    }
